...
def build_agent_prompt(
    ...
    lines.extend([
        ...
        "- DELIVERY_RESULT must include exactly these headings: status, summary, artifacts, validation_evidence, review_evidence, remaining_risks, human_action, next_action.",
        "- DELIVERY_RESULT status must be ready or not_ready.",
        "- DELIVERY_RESULT completion is fail-closed: do not mark delivery complete with free-form prose or placeholder evidence.",
