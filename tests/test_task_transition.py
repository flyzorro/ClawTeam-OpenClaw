...
def test_plan_terminal_writeback_rejects_missing_execution_id_for_worker_runtime():
    task = TaskItem(
        id="task-1",
        subject="impl",
...
def test_plan_terminal_writeback_allows_missing_execution_id_for_manual_path():
    task = TaskItem(
        id="task-1",
        subject="impl",
        status=TaskStatus.in_progress,
